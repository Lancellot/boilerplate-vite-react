...
export default function Footer() {
    return (
        <footer className="sticky top-0 z-50 flex items-center justify-between px-12 py-4
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10">
                    ...
                    <section className="flex flex-col items-center lg:items-start">
                        <header className="flex items-center gap-3 mb-4">
                            <img src={Logo} alt="Logo Lorem" className="w-16 h-16 sm:w-20 sm:h-20" />
                            <div>
                    ...
                    <section className="flex flex-col items-center lg:items-start">
                        ...
                        <figure className="bg-gray-800 rounded-xl p-4 hover:bg-gray-700 transition-all duration-200">
                            <img src={Logo} alt="Parceiro Lorem" className="h-10 sm:h-12 w-auto object-contain" />
                        </figure>
